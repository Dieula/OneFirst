...
public class ListMagasinAdapterProduit extends RecyclerView.Adapter<ListMagasinAdapterProduit.ViewHolder> {
   ...
   /* public ProductListAdapter(Context context, ArrayList<Product> dataList, ListTypeShow listTypeShow) {
    ...
    public ListMagasinAdapterProduit( Context context,List<Product> dataList, ListTypeShow listTypeShow) {
        this.mContext = context;
        this.dataList = dataList;
        this.listTypeShow = listTypeShow;
    }
